       ...
       <form action="" method="post">
       	<table class="maxTable">
           	<tr>
                   ...
                   <td rowspan="2" style="color: #999;">Indtast din email adresse. Email vil bruges til at logge på senere, og eventuelt til senere festivaller, hvor du også gerne vil hjælpe til i madboden.</td>
               </tr>
               <tr>
               	<td><label for="email_repeat">Gentag email</label></td>
                   <td><input id="email_repeat" name="email_repeat" type="email" /></td>
               </tr>
           	<tr>
               	<td><label for="fname">Fornavn</label></td>
                   <td><input id="fname" name="fname" type="text" /></td>
                   <td style="color: #999;">Skriv dine for- og eventuelle mellemnavne.</td>
               </tr>
               <tr>
               	<td><label for="lname">Efternavn</label></td>
                   <td><input id="lname" name="lname" type="text" /></td>
                   <td style="color: #999;">Skriv dit efternavn.</td>
               </tr>
               <tr>
               ...
               <tr>
                   ...
                   <td style="color: #999;">Vælg det land, du er bosiddende i.</td>
               </tr>
               <tr>
               ...
               <tr>
                ...
                <tr>
                	<td><input name="submit" type="submit" value="Indsend tilmelding" /></td>
